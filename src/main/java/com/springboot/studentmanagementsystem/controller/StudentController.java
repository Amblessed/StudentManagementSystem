...
public class StudentController {
    ...
    public String listStudents(Model model){
        ...
        return "students";  /*students is the view name. It must be stored in the templates folder*/
    }
    ...
    public String createStudentForm(@ModelAttribute("student") Student student){
